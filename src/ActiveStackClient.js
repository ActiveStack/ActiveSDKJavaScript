angular.module('ActiveStack.Client', ['ActiveStack.Config','ActiveStack.Model'], function($provide) {
    $provide.factory('ActiveStackClient', function($log, ActiveStackConfig, ActiveStackModel) {
        ActiveStackClient = function() {
            Decorate.withEventDispatcher(this);

            var self = this;
            var config = ActiveStackConfig;
            var model = ActiveStackModel;
            var socket;
            ...
            var connectTimeout = null;
             this.connect = function() {
                ...
                socket.on('connect_failed', function() {
                    console.log("ActiveStackClient:connect_failed");
                });
                socket.on('reconnect_failed', function() {
                    console.log("ActiveStackClient:reconnect_failed");
                });
                socket.on('error', function() {
                    console.log("ActiveStackClient:error");
                });
